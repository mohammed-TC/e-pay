...
mixin _$Merchant {
 ...
 String get id; String get name; String get category; String get qrCode; Money? get fixedAmount;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Merchant&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.category, category) || other.category == category)&&(identical(other.qrCode, qrCode) || other.qrCode == qrCode)&&(identical(other.fixedAmount, fixedAmount) || other.fixedAmount == fixedAmount));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,category,qrCode,fixedAmount);

@override
String toString() {
  return 'Merchant(id: $id, name: $name, category: $category, qrCode: $qrCode, fixedAmount: $fixedAmount)';
}
...
@useResult
$Res call({
 String id, String name, String category, String qrCode, Money? fixedAmount
});


$MoneyCopyWith<$Res>? get fixedAmount;
...
/// Create a copy of Merchant
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? category = null,Object? qrCode = null,Object? fixedAmount = freezed,}) {
...
@pragma('vm:prefer-inline')
$MoneyCopyWith<$Res>? get fixedAmount {
    if (_self.fixedAmount == null) {
    return null;
  }

  return $MoneyCopyWith<$Res>(_self.fixedAmount!, (value) {
    return _then(_self.copyWith(fixedAmount: value));
  });
}
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String category,  String qrCode,  Money? fixedAmount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Merchant() when $default != null:
return $default(_that.id,_that.name,_that.category,_that.qrCode,_that.fixedAmount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String category,  String qrCode,  Money? fixedAmount)  $default,) {final _that = this;
switch (_that) {
case _Merchant():
return $default(_that.id,_that.name,_that.category,_that.qrCode,_that.fixedAmount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String category,  String qrCode,  Money? fixedAmount)?  $default,) {final _that = this;
switch (_that) {
case _Merchant() when $default != null:
return $default(_that.id,_that.name,_that.category,_that.qrCode,_that.fixedAmount);case _:
  return null;
...
class _Merchant implements Merchant {
  const _Merchant({required this.id, required this.name, required this.category, required this.qrCode, this.fixedAmount});
...
@override final  Money? fixedAmount;
...
@override $MoneyCopyWith<$Res>? get fixedAmount;
...
/// Create a copy of Merchant
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? category = null,Object? qrCode = null,Object? fixedAmount = freezed,}) {
