...
class AppColors extends ThemeExtension<AppColors> {
  ...
  static const light = AppColors(
    surfacePage: Color(0xFFFBFCFA),
    surfaceCard: Color(0xFFFFFFFF),
    surfaceSunken: Color(0xFFEEF1ED),
    inkPrimary: Color(0xFF0B140F),
    inkSecondary: Color(0xFF4A564F),
    inkTertiary: Color(0xFF8A968F),
    accentPrimary: Color(0xFF00A868),
    accentDeep: Color(0xFF00703F),
    accentTint: Color(0xFFC9F2DE),
    plateShadow: Color(0xFF0B140F),
  ...
  static const dark = AppColors(
    ...
    accentPrimary: Color(0xFF29D999),
    accentDeep: Color(0xFF00A868),
    accentTint: Color(0xFF0E3A2A),
