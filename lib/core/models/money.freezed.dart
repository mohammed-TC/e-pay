...
mixin _$Money {
 ...
 int get minorUnits; String get currencyCode;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Money&&(identical(other.minorUnits, minorUnits) || other.minorUnits == minorUnits)&&(identical(other.currencyCode, currencyCode) || other.currencyCode == currencyCode));
}
...
@useResult
$Res call({
 int minorUnits, String currencyCode
});
...
/// Create a copy of Money
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? minorUnits = null,Object? currencyCode = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int minorUnits,  String currencyCode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Money() when $default != null:
return $default(_that.minorUnits,_that.currencyCode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int minorUnits,  String currencyCode)  $default,) {final _that = this;
switch (_that) {
case _Money():
return $default(_that.minorUnits,_that.currencyCode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int minorUnits,  String currencyCode)?  $default,) {final _that = this;
switch (_that) {
case _Money() when $default != null:
return $default(_that.minorUnits,_that.currencyCode);case _:
  return null;
...
class _Money extends Money {
  const _Money({required this.minorUnits, this.currencyCode = 'OMR'}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Money&&(identical(other.minorUnits, minorUnits) || other.minorUnits == minorUnits)&&(identical(other.currencyCode, currencyCode) || other.currencyCode == currencyCode));
}
...
/// Create a copy of Money
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? minorUnits = null,Object? currencyCode = null,}) {
  return _then(_Money(
minorUnits: null == minorUnits ? _self.minorUnits : minorUnits // ignore: cast_nullable_to_non_nullable
as int,currencyCode: null == currencyCode ? _self.currencyCode : currencyCode // ignore: cast_nullable_to_non_nullable
as String,
